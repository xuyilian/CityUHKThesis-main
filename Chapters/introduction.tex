...
in its own right~\cite{chen2017biologically,zufferey2019consecutive}.
...
and flight~\cite{zufferey2019consecutive,chen2017biologically}.  Across these efforts, water contact is generally
...
include impulsive jumping~\cite{zufferey2019consecutive}, rapid gas generation or
combustion~\cite{chen2017biologically}, and simply oversizing the propulsion system to overcome
surface adhesion and accelerate from rest~\cite{alzubi2018loon}.  These approaches enable a
...
sinks~\cite{clanet2004secrets}.  These studies characterise the conditions for a successful skip (approach angle, speed, and spin) but consider passive, unpowered
