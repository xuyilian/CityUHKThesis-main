...
travels across water in a sequence of hops, the impulse for each one coming
from hydrofoils driven by its own rotation.  Across the contacts reported here
the vehicle leaves the water at an average of $60\%$ of its entry speed, so
roughly $40\%$ of the kinetic energy of the descent is returned as climb, and
the rest of the work of reversal is paid for out of the spin.  The contact is
lossy, but it removes the need to accelerate from rest off the surface, and it
treats the water as something to move across rather than as a place to land,
dive, or sample.
